...
# Versione stabile 1.0 (corpo invariato) + interfaccia grafica Streamlit
# ==================================================
...
if file_attivita and file_clienti:
    ...
    # ==================================================
    # 🔵 SCRIPT 1.0 IDENTICO (solo adattato per Streamlit)
    # ==================================================
    ...
    # =========================
    # 5. Attività senza cliente → Amministratori
    # =========================
    ...
    # 7. Salva Excel (dati)
    # =========================
    output_path = "report_attivita_clienti.xlsx"
    col_order = [
